function sims = default_simulations(type, opt)
    arguments
        type (1,1) string {mustBeMember(type, ["symmetric", "nonsymmetric"])}
    ...
    sims = add(sims, "rich (α = 0.85)", ...
        @(A, b, tol, Nit) rich(A, b, tol, Nit, 0.85), ...
        symmetric = true, nonsymmetric = true);
    ...
    sims = add(sims, "rich (α = 0.65)", ...
        @(A, b, tol, Nit) rich(A, b, tol, Nit, 0.65), ...
        symmetric = true, nonsymmetric = true);
    ...
    sims = add(sims, "qmr", ...
        ...
        nonsymmetric = true, symmetric = true, itfactor = 2, require_adjoint = true);
